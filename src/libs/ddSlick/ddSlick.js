(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            '.dd-select{ background: transparent; border-radius:2px;  position:relative; cursor:pointer;}' +
            '.dd-desc { color:#aaa; display:block; overflow: hidden; font-weight:normal; line-height: 1.4em; }' +

            '.dd-selected{ height: 50px; overflow:hidden; display:flex; align-items: center; padding:10px; font-weight:bold;}' +
            ...
            '.dd-options{ border:solid 1px #ccc; border-top:none; list-style:none; box-shadow:0px 1px 5px #ddd; display:none; position:absolute; z-index:2000; margin:0; padding:0; background: transparent; overflow:auto;}' +
            '.dd-option{  height: 50px; padding:10px; display:flex; align-items: center; border-bottom:solid 1px #ddd; overflow:hidden; text-decoration:none; color:#fff; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }' +
            '.dd-options > li:last-child >' +
            ' .dd-option{   display: flex; align-items: center; border-bottom:none;}' +
            '.dd-option:hover{ background:#f3f3f3; color:#000;}' +
            '.dd-selected-description-truncated { text-overflow: ellipsis; white-space:nowrap; }' +
            '.dd-option-selected { background:transparent; }' +
            '.dd-option-image, ' +
            '.dd-selected-image {width: 32px; height: 32px; border-radius: 50%;  vertical-align:middle; float:left; margin-right:8px; max-width:64px;}' +
